...
""")
    print("""
This autograding is provided to you as **FEEDBACK** tool to support your progress towards 
your solution. As such, the results obtained may not constitute the final mark for the project, 
which may be  affected also by new tests, and an assessment on SE quality followed, interviews, etc.
